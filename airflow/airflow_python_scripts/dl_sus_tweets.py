def dl_sus_tweets():
    ...
    for tempName, tempStatusNumber in accountsToRecheckDict.items():
        ...
        try:
            ...
            df_ledger.to_sql(con=database_connection, name='accounts_ledger', if_exists='append', index=False)
            ...
            df.to_sql(con=database_connection, name='tweets001', if_exists='append', index=False)
