...
def start_ec2():
    ...
    # Unknown parameter in input: "instance_ids", must be one of: InstanceIds, Hibernate, DryRun, Force; 3153)

with DAG(
    dag_id='kw_ec2_start_kafka',
    tags=["kw"],
    ...
    task2 = PythonOperator(task_id='stop_ec2', python_callable=start_ec2)
